...
<?php $nekaj = $designClass->buttons_with_condition(true, array('button_private_exit', 'button_lunch_exit', 'button_work_exit', 'button_final_exit')); ?>
        ...
        <form action="action.php" method="get" enctype="application/x-www-form-urlencoded" name="forma"> <input name="ajdi" type="text" size="1" onKeyPress="return submitenter(this,event)" />
